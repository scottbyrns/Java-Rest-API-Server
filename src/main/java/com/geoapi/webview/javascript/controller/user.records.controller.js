...
function ConvertJsonToTable(parsedJson, tableId, tableClassName, linkText)
{
    ...
    var tbl = '<table class="hovertable" border="1" cellpadding="1" cellspacing="1"' + idMarkup + classMarkup + '>{0}{1}</table>';
...
LiveWidgets.addWidget({
	...
	constructor: function () {
                    var url = "notary/getForUser:71dcc775-283b-4897-95b7-5328e6191943";
                    $.get(url, function(data) {
                    var jsonHtmlTable = ConvertJsonToTable(data.response, 'jsonTable', null, 'Notary');
